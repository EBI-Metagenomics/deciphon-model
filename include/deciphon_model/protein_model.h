...
enum model_rc protein_model_add_node(struct protein_model *,
                                     imm_float const lp[IMM_AMINO_SIZE],
                                     char consensus);

enum model_rc protein_model_add_trans(struct protein_model *,
                                      struct protein_trans trans);
...
enum model_rc protein_model_setup(struct protein_model *, unsigned core_size);
