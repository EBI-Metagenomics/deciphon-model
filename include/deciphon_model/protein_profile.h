...
enum model_rc protein_profile_absorb(struct protein_profile *prof,
                                     struct protein_model const *model);

enum model_rc protein_profile_sample(struct protein_profile *prof,
...
enum model_rc protein_profile_read(struct protein_profile *prof,
