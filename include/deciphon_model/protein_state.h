...
{
    return protein_state_id_msb(id) == PROTEIN_MATCH_STATE;
}

static inline bool protein_state_is_insert(unsigned id)
{
    return protein_state_id_msb(id) == PROTEIN_INSERT_STATE;
}

static inline bool protein_state_is_delete(unsigned id)
{
    return protein_state_id_msb(id) == PROTEIN_DELETE_STATE;
}
